...
class Retail extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            saturations: new Map([
                ['Apples', '1.1240130001137616'],
                ['Coffee', '2.860829913507773'],
                ['Eggs', '0.7537144015183443'],
                ['Grapes', '1.262785667351242'],
                ['Oranges', '1.130672533367329'],
                ['Sausage', '1.2823212449977626'],
                ['Steak', '2.0399182573076855'],
            ]),
            retailmodel: "",
            max: 0,
            maxI: 0
